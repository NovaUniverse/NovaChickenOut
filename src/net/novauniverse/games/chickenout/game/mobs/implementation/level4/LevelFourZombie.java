...
public class LevelFourZombie extends MobProviderWithRandomArmor {
    ...
    public Creature spawn(Location location, Player player) {
        ...
        creature.getEquipment().setItemInMainHand(new ItemBuilder(VersionIndependentMaterial.GOLDEN_SWORD).setUnbreakable(true).setAmount(1)
                .addEnchant(Enchantment.FIRE_ASPECT, 1).addEnchant(Enchantment.DAMAGE_ALL,1).build());
